...
export type DescriptionPiece = string | BoldDescription | ItalicDescription | IconDescription | KeywordDescription | RuleDescrition | HeroClassDescription | TeamDescription | DividerDescription;
