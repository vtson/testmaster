 ...
 */
export declare enum CardDetailsType {
    /**
 ...
 */
export type ByCardTypeAndSetAndGroup = {
    [key: string]: CardSearchResult[];
};
/**
 * Card broser by card type and set.
 */
export type ByCardTypeAndSet = {
    [key: string]: ByCardTypeAndSetAndGroup;
};
/**
 * Card browser by card type.
 */
export type ByCardType = {
    [key in CardType]?: ByCardTypeAndSet;
};
