      ...
      <div class="mb-5!">
        <div class="relative">
          <input
            ...
            placeholder=" "
            class="peer w-full px-1 pt-7 pb-3 text-lg text-slate-800 bg-transparent border-0 border-b-2 border-gray-300 rounded-none outline-0 focus:border-blue-500 transition-all duration-200"
            id="search-card-input"
          />
          <label
            for="search-card-input"
            class="absolute left-1 top-1/2 -translate-y-1/2 text-base text-gray-400 pointer-events-none transition-all duration-200 peer-focus:top-0 peer-focus:translate-y-0 peer-focus:text-xs peer-focus:text-blue-500 peer-[:not(:placeholder-shown)]:top-0 peer-[:not(:placeholder-shown)]:translate-y-0 peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:text-gray-500"
          >
            Search card
          </label>
        </div>
